...
<>
    ...
    <style>
        ...
        .signup.buyer {
            background-image: url("../../assets/images/Customer.jpeg");
            background-size: cover;
            background-position: center;
        }

        .signup.supplier {
            background-image: url("../../assets/images/Supplier.jpeg");
            background-size: cover;
            background-position: center;
        }

        .signup.veterinarian {
            background-image: url("../../assets/images/Veterinarian.jpeg");
            background-size: cover;
            background-position: center;
        }
