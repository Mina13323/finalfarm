...
<body>
    <div class="supplier-page">
        ...
        <div class="supplies-wrapper">
            <!-- Supply 1 -->
            <div class="supply">
                <img src="/public/assets/images/images1.jpeg" alt="Product Image" />
                <h2>كتاكيت</h2>
                <p>
            ...
            <!-- Supply 2 -->
            <div class="supply">
                <img src="/public/assets/images/images2.jpeg" alt="Product Image" />
                <h2>نشاره خشب</h2>
            ...
            <!-- Supply 3 -->
            <div class="supply">
                <img src="/public/assets/images/images3.jpeg" alt="Product Image" />
                <h2>علف</h2>
                <p>
            ...
            <!-- Supply 4 -->
            <div class="supply">
                <img src="/public/assets/images/images4 .jpeg" alt="Product Image" />
                <h2>فراخ بيضه</h2>
